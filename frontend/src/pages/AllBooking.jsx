...
import BookingComponent from "../BookingClient/BookingComponent";
  ...
  >
    <TiTick className="me-2 w-max text-2xl" /> Completed
      ...
      <div className="flex flex-col items-center mt-10 text-slate-200">
        ...
        <p className="text-gray-500 mb-10 text-base text-center">
          ...
          <div className="bg-gray-800 text-slate-200 p-4 fixed min-h-[92vh] w-[50vw] flex flex-col justify-between">
            ...
            <div className="flex flex-col justify-start gap-y-8">
              <div className="p-2 hover:bg-[#1f1f1f9a]">
                ...
                >
                  <MdOutlineClearAll className="me-2 text-2xl" />
                  All Bookings
                </button>
              </div>
              <div className="p-2 hover:bg-[#1f1f1f9a]">
                ...
                >
                  <MdPending className="me-2 text-2xl" />
                  Pending
                </button>
              </div>
              <div className="p-2 hover:bg-[#1f1f1f9a]">
                ...
                >
                  <MdSmsFailed className="me-2 text-2xl" />
                  Failed
                </button>
              </div>
              <div className="p-2 hover:bg-[#1f1f1f9a]">
                ...
                >
                  <TiTick className="me-2 text-2xl" />
                  Completed
                </button>
              </div>
            </div>
  ...
  return (
    <div>
      ...
      <div className="bg-[#fafafa]" style={{ minHeight: "90vh" }}>
        ...
        <div className="flex">
          <div className="xl:w-[15%] lg:w-[20%] sm:w-[30%] hidden sm:block fixed">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 ">
                {filteredBookings.length === 0 ? (
                  ...
                  filteredBookings
                    ...
                    .reverse()
                    .map((item) => (
                      <BookingComponent item={item} key={item._id} />
                    ))
                )}
              </div>
            )}
