...
const Navbar = () => {
  return (
    <nav className="flex flex-col sm:flex-row justify-between items-center bg-white shadow-md p-4">
      {/* Logo Section */}
      <div className="flex items-center sm:ms-14">
      ...
      {/* Navigation Links */}
      <div className="flex space-x-4 sm:space-x-8 my-4 sm:my-0">
        <Link
          to="/"
      ...
      <div className="hidden sm:flex sm:me-8">
        <Link
          to="/"
          className="bg-[#fe4b01] text-white text-sm font-medium py-2 px-4 rounded shadow hover:bg-[#e44301] transition w-max"
        >
          Contact
        </Link>
      </div>
